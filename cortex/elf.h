...
#define EI_NIDENT       16
	...
	static char sz_desc_e_type[][128] = {	"No file type",
									"Relocatable file",
									"Executable file",
									"Shared object file",
									"Core file"
	...
	static char sz_desc_e_machine[][128] = {"No mach", "AT&T", "SPARC", "80386", "Motorola 68", "Motorola 88", "Unknown", "8086", "MIPS"};
	
	static char sz_desc_e_entry[] = "Entry point.";
	...
	static char sz_desc_p_type[][128] = {"PT_NULL", "PT_LOAD", "PT_DYNAMIC", "PT_INTERP", "PT_NOTE", "PT_SHLIB", "PT_PHDR"};
	...
	static char sz_desc_sh_type[][128] = {	"SHT_NULL", "SHT_PROGBITS", "SHT_SYMTAB", "SHT_STRTAB",
									"SHT_RELA", "SHT_HASH", "SHT_DYNAMIC", "SHT_NOTE",
									"SHT_NOBITS", "SHT_REL", "SHT_SHLIB", "SHT_DYNSYM"};	
	static char sz_desc_sh_flags[][128] = {"Unknown", "SHF_WRITE", "SHF_ALLOC", "SHF_WRITE & SHF_ALLOC", "SHF_EXECINSTR",
									"SHF_WRITE & SHF_ALLOC", "SHF_ALLOC & SHF_EXECINSTR",
									"SHF_WRITE & SHF_ALLOC & SHF_EXECINSTR"};
	
	static char sz_desc_sh_addr[] = "Position in Mem.";
	
	static char sz_desc_sh_offset[] = "Position in file.";